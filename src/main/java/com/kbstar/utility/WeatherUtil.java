...
public class WeatherUtil {
    public static String getWeather1(String loc) throws Exception{
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=R6XTDAtPn1psOlxitX0FdNF14tt0tmnfP%2BiuDzE6EC31DKTJbhVGqc51R%2FzJqMAttfho3w04G0a8ji2H6oSWLQ%3D%3D"); /*Service Key*/
...
//        System.out.println(sb.toString());
        ...
        String result = (String) wfSv.get("wfSv");
